...
function create_else_block$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(section0, file$8, 105, 2, 2408);
			attr_dev(section1, "id", "meetups");
			attr_dev(section1, "class", "svelte-18e9u1f");
			add_location(section1, file$8, 112, 2, 2680);
		},
		m: function mount(target, anchor) {
...
// (108:4) <Button on:click={() => dispatch("edit")}>
function create_default_slot$3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(108:4) <Button on:click={() => dispatch(\\\"edit\\\")}>",
		ctx
	});
...
// (110:2) {#if filteredMeetups.length === 0}
function create_if_block_1$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$8, 110, 4, 2602);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, p, anchor);
			append_hydration_dev(p, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(110:2) {#if filteredMeetups.length === 0}",
		ctx
	});
...
// (114:4) {#each filteredMeetups as meetup (meetup.id)}
function create_each_block(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(div, file$8, 114, 6, 2759);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(114:4) {#each filteredMeetups as meetup (meetup.id)}",
		ctx
	});
