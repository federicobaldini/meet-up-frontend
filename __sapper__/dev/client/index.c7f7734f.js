...
function create_else_block$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(section0, file$8, 108, 2, 2465);
			attr_dev(section1, "id", "meetups");
			attr_dev(section1, "class", "svelte-18e9u1f");
			add_location(section1, file$8, 115, 2, 2737);
		},
		m: function mount(target, anchor) {
...
// (111:4) <Button on:click={() => dispatch("edit")}>
function create_default_slot$3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(111:4) <Button on:click={() => dispatch(\\\"edit\\\")}>",
		ctx
	});
...
// (113:2) {#if filteredMeetups.length === 0}
function create_if_block_1$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$8, 113, 4, 2659);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, p, anchor);
			append_hydration_dev(p, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(113:2) {#if filteredMeetups.length === 0}",
		ctx
	});
...
// (117:4) {#each filteredMeetups as meetup (meetup.id)}
function create_each_block(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(div, file$8, 117, 6, 2816);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(117:4) {#each filteredMeetups as meetup (meetup.id)}",
		ctx
	});
