...
function create_else_block$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(section0, file$8, 100, 2, 2318);
			attr_dev(section1, "id", "meetups");
			attr_dev(section1, "class", "svelte-18e9u1f");
			add_location(section1, file$8, 107, 2, 2590);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$8, 105, 4, 2512);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, p, anchor);
			append_hydration_dev(p, t);
...
function create_each_block(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(div, file$8, 109, 6, 2669);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, div, anchor);
...
function instance$8($$self, $$props, $$invalidate) {
	...
	onMount(() => {
		customMeetupsStore.subscribe(items => $$invalidate(9, fetchedMeetups = items));
