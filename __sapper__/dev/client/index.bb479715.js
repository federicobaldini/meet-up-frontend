...
function create_else_block$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(section0, file$8, 100, 2, 2287);
			attr_dev(section1, "id", "meetups");
			attr_dev(section1, "class", "svelte-18e9u1f");
			add_location(section1, file$8, 107, 2, 2559);
		},
		m: function mount(target, anchor) {
...
// (103:4) <Button on:click={() => dispatch("edit")}>
function create_default_slot$3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(103:4) <Button on:click={() => dispatch(\\\"edit\\\")}>",
		ctx
	});
...
// (105:2) {#if filteredMeetups.length === 0}
function create_if_block_1$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$8, 105, 4, 2481);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, p, anchor);
			append_hydration_dev(p, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(105:2) {#if filteredMeetups.length === 0}",
		ctx
	});
...
// (109:4) {#each filteredMeetups as meetup (meetup.id)}
function create_each_block(key_1, ctx) {
	...
	meetupitem.$on("showdetails", /*showdetails_handler*/ ctx[11]);
	meetupitem.$on("edit", /*edit_handler*/ ctx[12]);
	meetupitem.$on("error", /*error_handler*/ ctx[13]);
	...
	const block = {
		...
		h: function hydrate() {
			add_location(div, file$8, 109, 6, 2638);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, div, anchor);
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty & /*filteredMeetups*/ 8) meetupitem_changes.id = /*meetup*/ ctx[17].id;
			if (dirty & /*filteredMeetups*/ 8) meetupitem_changes.title = /*meetup*/ ctx[17].title;
			if (dirty & /*filteredMeetups*/ 8) meetupitem_changes.subtitle = /*meetup*/ ctx[17].subtitle;
			if (dirty & /*filteredMeetups*/ 8) meetupitem_changes.description = /*meetup*/ ctx[17].description;
			if (dirty & /*filteredMeetups*/ 8) meetupitem_changes.imageUrl = /*meetup*/ ctx[17].imageUrl;
			if (dirty & /*filteredMeetups*/ 8) meetupitem_changes.address = /*meetup*/ ctx[17].address;
			if (dirty & /*filteredMeetups*/ 8) meetupitem_changes.isFavorite = /*meetup*/ ctx[17].isFavorite;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(109:4) {#each filteredMeetups as meetup (meetup.id)}",
		ctx
	});
...
function instance$8($$self, $$props, $$invalidate) {
	...
	const setFilter = event => {
		$$invalidate(9, favoritesOnly = event.detail === 1);
	};
	...
	$$self.$inject_state = $$props => {
		if ('fetchedMeetups' in $$props) $$invalidate(14, fetchedMeetups = $$props.fetchedMeetups);
		...
		if ('favoritesOnly' in $$props) $$invalidate(9, favoritesOnly = $$props.favoritesOnly);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*favoritesOnly*/ 512) {
